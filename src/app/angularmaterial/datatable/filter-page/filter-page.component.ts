...
export class FilterPageComponent implements AfterViewInit, OnInit {

  constructor(private airtableCrud: AirtableCrudService){}

  dataSource = new MatTableDataSource<any>();

  displayedColumns = ['id', 'UserName', 'UserID', 'Passcode'];
  ...
  getdata(){
    this.airtableCrud.getDataAirtable().subscribe((data) => {
      //     this.AirTableData = data.records;
         this.dataSource = new MatTableDataSource<IAirTable>(data.records);
